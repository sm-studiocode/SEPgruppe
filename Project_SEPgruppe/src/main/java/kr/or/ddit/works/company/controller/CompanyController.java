...
public class CompanyController {
    ...
    public String updateCompanyFormUI(
        ...
        // 2. 고객사 정보 조회
        // ❌ 기존: CompanyVO member = companyService.selectCompany(authentication.getName());
        CompanyVO member = companyService.selectCompany(contactId);
